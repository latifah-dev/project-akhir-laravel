<script>
  ...
  hapus: (id) => {
        console.log(id);
        const respon = fetch(`http://127.0.0.1:8000/api/itemtransaksi/${id}/delete`,{
            method: 'POST',
        })
        .then( (response) => {
            location.reload();
					...
					<template x-for="cartitem in cart">
            			<div class="flex justify-between items-center mt-6 pt-6">
            				<div class="flex  items-center">
            					<img :src="'http://127.0.0.1:8000/storage/images/'+cartitem.product.image" width="60" class="rounded-full ">
